              ...
              <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingOne">
                    ...
                    >
                      <span>
                        1. What are the benefits of social media marketing for
                        my company?
                      </span>
                    </button>
                  </h2>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        Yes! No matter how large or small, if you have a
                        business, you need a website. And if you need a website
                        – and you want it to help you make money – you need
                        marketing.
                      </p>
                    </div>
                  </div>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        There is no magical number you can set for seeing
                        results from inbound marketing. As a general rule of
                        thumb, in our experience, companies start hitting their
                ...
                <div className="accordion-item">
                  <h2 className="accordion-header" id="headingFoure">
                    ...
                    >
                      <span>
                        5. Does Google Ads Really Mean Immediate Traffic?
                      </span>
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        Yes – you can get traffic overnight with Google Ads
                        (formerly known as Google AdWords), a paid traffic
                        solution that shows ads to people when they search
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        The first aspect to focus on is, you guessed it, your
                        audience. You need to know who you're tailoring
                        messaging for and how to position your brand in a way
                        that catches and holds their attention.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        A blog is the part of your website that’s constantly
                        updated. Every time you post a piece of writing – which
                        you might hear called a post or article – it shows up on
                        your blog. It’s a great way to keep leads and customers
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        Marketers who have limited experience with content
                        marketing often worry that the cost of creating content
                        is just too expensive for their company. The reality is
                        that marketers often expect to pay way more than
